...
class b2PolyShape extends b2Shape {
	...
	var syncMat = new b2Mat22();
	var m_localCentroid = new b2Vec2();

	// Local position oriented bounding box. The OBB center is relative to
	// shape centroid.
	var m_localOBB = new b2OBB();
	var m_vertices: b2Vec2[];
	...
	function constructor(def: b2ShapeDef, body: b2Body, newOrigin: b2Vec2) {
		...
		*/
		...
		// Vertices
		this.m_vertices = []: b2Vec2[]; this.m_vertices.length = b2Settings.b2_maxPolyVertices;
		this.m_coreVertices = []: b2Vec2[]; this.m_coreVertices.length = (b2Settings.b2_maxPolyVertices);
		//for (i = 0; i < b2Settings.b2_maxPolyVertices; i++)
		//	this.m_vertices[i] = new b2Vec2();

		// Normals
		this.m_normals = []: b2Vec2[]; this.m_normals.length = (b2Settings.b2_maxPolyVertices);
		//for (i = 0; i < b2Settings.b2_maxPolyVertices; i++)
	...
	static var tempVec = new b2Vec2();
	static var tAbsR = new b2Mat22();
}
