...
class b2Collision {
	...
	static function EdgeSeparation(poly1: b2PolyShape, edge1: number, poly2: b2PolyShape): number {
	...
	static function FindMaxSeparation(edgeIndex: number[], poly1: b2PolyShape, poly2: b2PolyShape, conservative: boolean): number
	{
	...
	static function FindIncidentEdge(c: ClipVertex[], poly1: b2PolyShape, edge1: number, poly2:b2PolyShape): void
	{
		var count1 = poly1.m_vertexCount;
		var vert1s = poly1.m_vertices;
		var count2 = poly2.m_vertexCount;
	...
	static var b2CollidePolyTempVec = new b2Vec2();
	static function b2CollidePoly(manifold: b2Manifold, polyA: b2PolyShape, polyB: b2PolyShape, conservative: boolean): void {
