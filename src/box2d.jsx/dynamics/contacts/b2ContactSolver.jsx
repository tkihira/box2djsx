...
class b2ContactSolver {
	...
	var m_constraints: b2ContactConstraint[];
	var m_constraintCount: number;

	function constructor(contacts: b2Contact[], contactCount: number, allocator: variant){
		// initialize instance variables for references
		this.m_constraints = []: b2ContactConstraint[];
		//
	...
	function SolvePositionConstraints(beta: number): boolean {
